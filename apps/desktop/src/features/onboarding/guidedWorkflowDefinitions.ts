...
> = Object.freeze({
  "create-first-sign": goal(
    ...
    [
      { id: "choose-size-material", title: "Choose size and material", description: "Set the real stock size and the material you plan to use.", surface: "create" },
      { id: "add-content", title: "Add your sign content", description: "Add shapes, sign layout, or text to the stock.", surface: "create" },
      { id: "analyze-cutability", title: "Check the design", description: "Run the manufacturability check on the current design.", surface: "analysis" },
      ...
      { id: "save-export", title: "Save or export", description: "Save the LaserX project and export editable artwork when ready.", surface: "output" },
    ],
    ["resolve-findings"],
  ),
  "import-own-design": goal(
    ...
    "Bring in vector artwork or trace an image, then size and check it.",
    [
      { id: "choose-file", title: "Choose your artwork", description: "Import SVG or DXF artwork, or trace a PNG or JPEG.", surface: "import" },
      { id: "prepare-source", title: "Prepare the artwork", description: "Review vector import or raster tracing before accepting editable paths.", surface: "import" },
      { id: "assign-physical", title: "Set physical details", description: "Confirm stock size, material, thickness, and layer roles.", surface: "create" },
      { id: "analyze-cutability", title: "Check the design", description: "Run the manufacturability check on the imported design.", surface: "analysis" },
      { id: "resolve-findings", title: "Review findings", description: "Resolve blocking findings before moving on.", surface: "analysis" },
      { id: "physical-preview", title: "Review the 3D result", description: "Confirm the physical stack-up before export.", surface: "preview" },
