# M11 — Layered Sign Workflow and Production Export
...
- separate cutability analysis per manufacturing layer;
...
7. Representative two- and three-layer sign packages pass independent inspection.
