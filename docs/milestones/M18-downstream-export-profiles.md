...
Issue #41 is the planning source.
...
No proprietary reverse engineering, native DWG, machine settings, toolpaths, G-code, controller communication, or replacement of downstream machine software belongs in M18.
